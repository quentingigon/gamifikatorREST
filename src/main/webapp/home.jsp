...
<div class="menuTop"><a href="/logout"> <i class="fas fa-sign-out-alt"></i> Log out</a>  <a href="/admin"> <i class="fas fa-cogs"></i> Admin</a> <div class="holder">     <img src="https://api.ning.com/files/*54juLYOTrMdu4eBaIkD5urGoLY-RZV7WCPaEMInPMnHNVM-k0nOmyGbBgR0pPONCf-vv7xrdDzY2efL-2SoM6jbvSFWFSn4/Gamification_head.png" alt="Avatar" />
    &nbsp;</div>  </div>
